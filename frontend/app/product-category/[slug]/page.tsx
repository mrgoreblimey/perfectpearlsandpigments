...
import HeroPopular from "@/components/category/HeroPopular";
        ...
        <div className="v2-wrap" style={{ padding: "26px 32px 34px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 32 }}>
            <div style={{ maxWidth: 560 }}>
              ...
              <p style={{ color: "#77746D", fontSize: "0.95rem", lineHeight: 1.75, fontWeight: 300, maxWidth: 520 }}>{category.description}</p>
            </div>
            <div style={{ display: "flex", alignItems: "flex-end", gap: 40, flexWrap: "wrap" }}>
              <HeroPopular products={products} />
