...
export const metadata: Metadata = {
  title: "Sign in — Perfect Pearls & Pigments",
};
...
export default async function LoginPage({
  ...
  const [{ nav }, { redirectTo }] = await Promise.all([getHomeData(), searchParams]);
        ...
        <div className="v2-wrap">
          <div className="auth-wrap">
            <div style={{ textAlign: "center", marginBottom: 30 }}>
              ...
              <h1 style={{ fontSize: "clamp(1.9rem,3vw,2.4rem)", letterSpacing: "-0.03em" }}>Welcome back</h1>
